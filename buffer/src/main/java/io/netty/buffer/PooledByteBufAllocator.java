...
public class PooledByteBufAllocator extends AbstractByteBufAllocator implements ByteBufAllocatorMetricProvider {
    ...
    private static int validateAndCalculatePageShifts(int pageSize) {
        ...
        // pageShift 的作用是通过对地址右移 PAGE_SHIFT 得到一个地址所在页的页号
        // 既然PageSize是 2 的幂数，所以该数字从右往左是连续的 "1"
        // 所以使用numberOfLeadingZeros计算 从最左边的 "1" 开始往左数有多少个 "0"
        // 而 Integer 是 32 位的，所以这里计算得到的 Shift 是要一个换挡变量
        //
        // 功能：给定一个PageNo（页码）
