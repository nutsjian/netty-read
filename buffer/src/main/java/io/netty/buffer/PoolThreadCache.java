...
final class PoolThreadCache {
    ...
    // 用于计算 normal 请求的数组索引 = log2(pageSize)
    ...
    /**
     * 当一个 ByteBuf 不再使用，arena 首先调用如下方法进行尝试缓存
     *
    ...
    private abstract static class MemoryRegionCache<T> {
         ...
         *  构造方法
         *
         *  MemoryRegionCache 使用了 jctools 包下的 MPSC（Multiple Producer Single Consumer）队列
         *  即多个生产者单一消费者队列，为什么要使用这种队列？//TODO
         *
         */
