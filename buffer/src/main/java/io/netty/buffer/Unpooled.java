 ...
 * Unpooled 用于创建一个新的字节 buf、包装和拷贝一个已经存在的byte[]、ByteBuffer 和 String
 *
...
public final class Unpooled {
     ...
     * returned buffer.
     *
     * 将 bytes 包装成一个 UnpooledHeapByteBuf 对象，而在包装过程中，是不会有拷贝操作的。
     * 即最后我们生成的 ByteBuf 对象是和 bytes 数组共用同一个存储空间的，对bytes的修改
     * 也会反映到ByteBuf 对象中
     *
     */
